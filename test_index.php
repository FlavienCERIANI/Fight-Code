...
while ((!$player1->mort()) && (!$player2->mort())) {
    ...
    ?>
    <label>
        <input type="checkbox" id="cbox1" value="attaque">
        Attaquer
    </label>

    <input type="checkbox" id="cbox2" value="potion"><label for="cbox2">
        Utiliser Potion
    </label>
